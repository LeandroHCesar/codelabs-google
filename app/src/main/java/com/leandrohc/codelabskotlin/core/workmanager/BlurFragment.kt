...
import com.leandrohc.codelabskotlin.databinding.FragmentBlurBinding

class BlurFragment : Fragment(R.layout.fragment_blur) {

    private lateinit var viewModel: BluerViewModel
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        viewModel = ViewModelProvider(this).get(BluerViewModel::class.java)
